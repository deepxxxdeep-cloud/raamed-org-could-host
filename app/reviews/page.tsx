    ...
    <main className="bg-[#f7fafb] text-[#102a43]">
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
        ...
        <div className="mt-14 grid gap-5 lg:grid-cols-3">
          {reviewList.map(([name, role, text]) => (
            <article key={name} className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
              <Quote className="size-8 text-[#f36f2b]" />
              <p className="mt-7 text-lg leading-8 text-slate-700">“{text}”</p>
